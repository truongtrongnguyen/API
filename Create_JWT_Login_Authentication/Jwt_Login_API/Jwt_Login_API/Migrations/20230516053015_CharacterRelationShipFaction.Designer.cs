...
namespace Jwt_Login_API.Migrations
{
    ...
    [Migration("20230516053015_CharacterRelationShipFaction")]
    partial class CharacterRelationShipFaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jwt_Login_API.Models.Character", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jwt_Login_API.Models.Backpack", b =>
                {
                    b.HasOne("Jwt_Login_API.Models.Character", "Character")
                        .WithOne("Backpack")
                        .HasForeignKey("Jwt_Login_API.Models.Backpack", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
